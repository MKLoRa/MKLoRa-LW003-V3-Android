...
public class WheelView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray attribute = context.obtainStyledAttributes(attrs, R.styleable.LW003V3WheelView);
        unitHeight = (int) attribute.getDimension(R.styleable.LW003V3WheelView_unitHeight, unitHeight);
        itemNumber = attribute.getInt(R.styleable.LW003V3WheelView_itemNumber, itemNumber);

        normalFont = attribute.getDimension(R.styleable.LW003V3WheelView_normalTextSize, normalFont);
        selectedFont = attribute.getDimension(R.styleable.LW003V3WheelView_selectedTextSize, selectedFont);
        normalColor = attribute.getColor(R.styleable.LW003V3WheelView_normalTextColor, normalColor);
        selectedColor = attribute.getColor(R.styleable.LW003V3WheelView_selectedTextColor, selectedColor);

        lineColor = attribute.getColor(R.styleable.LW003V3WheelView_lineColor, lineColor);
        lineHeight = attribute.getDimension(R.styleable.LW003V3WheelView_lineHeight, lineHeight);

        selectedBgColor = attribute.getColor(R.styleable.LW003V3WheelView_selectedBgColor, selectedBgColor);

        maskHeight = attribute.getDimension(R.styleable.LW003V3WheelView_maskHeight, maskHeight);
        noEmpty = attribute.getBoolean(R.styleable.LW003V3WheelView_noEmpty, true);
        isEnable = attribute.getBoolean(R.styleable.LW003V3WheelView_isEnable, true);
