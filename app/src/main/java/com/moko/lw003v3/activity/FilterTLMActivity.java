...
public class FilterTLMActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lw003_v3_activity_filter_tlm);
                                ...
                                switch (configKeyEnum) {
                                    ...
                                    case KEY_FILTER_EDDYSTONE_TLM_ENABLE:
                                        if (length > 0) {
                                            ...
                                            ivTlmEnable.setImageResource(mTLMEnable ? R.drawable.lw003_v3_ic_checked : R.drawable.lw003_v3_ic_unchecked);
                                        }
                                        break;
                                }
                            }
