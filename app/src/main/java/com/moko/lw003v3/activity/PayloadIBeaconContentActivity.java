...
import com.moko.lw003v3.databinding.Lw003V3ActivityPayloadIbeaconContentBinding;
...
public class PayloadIBeaconContentActivity extends BaseActivity {
    ...
    private Lw003V3ActivityPayloadIbeaconContentBinding mBind;
    private boolean savedParamsError;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = Lw003V3ActivityPayloadIbeaconContentBinding.inflate(getLayoutInflater());
