...
public class DeviceModeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lw003_v3_activity_device_mode);
        ...
        tvDeviceMode.postDelayed(() -> {
            LoRaLW003V3MokoSupport.getInstance().sendOrder(OrderTaskAssembler.getDeviceMode());
        }, 500);
    }
    ...
    public void selectDeviceMode(View view) {
        ...
        dialog.setListener(value -> {
            ...
            showSyncingProgressDialog();
            LoRaLW003V3MokoSupport.getInstance().sendOrder(OrderTaskAssembler.setDeviceMode(value + 1));
        });
