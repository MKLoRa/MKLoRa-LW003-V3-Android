...
public class FilterAdvNameActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lw003_v3_activity_filter_adv_name);
                                    ...
                                    case KEY_FILTER_NAME_RULES:
                                        if (length > 0) {
                                            ...
                                            for (int i = 0, l = filterAdvName.size(); i < l; i++) {
                                                ...
                                                View v = LayoutInflater.from(FilterAdvNameActivity.this).inflate(R.layout.lw003_v3_item_adv_name_filter, llDavName, false);
    ...
    public void onAdd(View view) {
        ...
        View v = LayoutInflater.from(this).inflate(R.layout.lw003_v3_item_adv_name_filter, llDavName, false);
        TextView title = v.findViewById(R.id.tv_adv_name_title);
