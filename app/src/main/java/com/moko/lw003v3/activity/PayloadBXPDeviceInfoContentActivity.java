...
import com.moko.lw003v3.databinding.Lw003V3ActivityPayloadBxpDeviceInfoContentBinding;
...
public class PayloadBXPDeviceInfoContentActivity extends BaseActivity {
    ...
    private Lw003V3ActivityPayloadBxpDeviceInfoContentBinding mBind;
    private boolean savedParamsError;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = Lw003V3ActivityPayloadBxpDeviceInfoContentBinding.inflate(getLayoutInflater());
