...
public class FilterBXPTagIdActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lw003_v3_activity_filter_bxp_tag_id);
                                    ...
                                    case KEY_FILTER_BXP_TAG_RULES:
                                        if (length > 0) {
                                            ...
                                            for (int i = 0, l = filterTagId.size(); i < l; i++) {
                                                ...
                                                View v = LayoutInflater.from(FilterBXPTagIdActivity.this).inflate(R.layout.lw003_v3_item_tag_id_filter, llTadId, false);
    ...
    public void onAdd(View view) {
        ...
        View v = LayoutInflater.from(this).inflate(R.layout.lw003_v3_item_tag_id_filter, llTadId, false);
        TextView title = v.findViewById(R.id.tv_tag_id_title);
