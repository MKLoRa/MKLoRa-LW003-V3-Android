...
import com.moko.lw003v3.databinding.Lw003V3ActivityFilterBxpTagIdBinding;
...
public class FilterBXPTagIdActivity extends BaseActivity {
    ...
    private Lw003V3ActivityFilterBxpTagIdBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw003V3ActivityFilterBxpTagIdBinding.inflate(getLayoutInflater());
                                    ...
                                    case KEY_FILTER_BXP_TAG_RULES:
                                        if (length > 0) {
                                            ...
                                            for (int i = 0, l = filterTagId.size(); i < l; i++) {
                                                ...
                                                View v = LayoutInflater.from(FilterBXPTagIdActivity.this).inflate(R.layout.lw003_v3_item_tag_id_filter, mBind.llTagId, false);
    ...
    public void onAdd(View view) {
        ...
        View v = LayoutInflater.from(this).inflate(R.layout.lw003_v3_item_tag_id_filter, mBind.llTagId, false);
        TextView title = v.findViewById(R.id.tv_tag_id_title);
