                                ...
                                switch (configKeyEnum) {
                                    case KEY_FILTER_RAW_DATA:
                                        if (length == 11) {
                                            ...
                                            mBind.ivFilterByBxpDevice.setImageResource(value[9] == 1 ? R.drawable.lw003_v3_ic_checked : R.drawable.lw003_v3_ic_unchecked);
                                            mBind.ivFilterByBxpAcc.setImageResource(value[10] == 1 ? R.drawable.lw003_v3_ic_checked : R.drawable.lw003_v3_ic_unchecked);
                                            mBind.ivFilterByBxpTh.setImageResource(value[11] == 1 ? R.drawable.lw003_v3_ic_checked : R.drawable.lw003_v3_ic_unchecked);
