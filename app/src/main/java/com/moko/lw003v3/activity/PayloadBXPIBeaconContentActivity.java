...
import com.moko.lw003v3.databinding.Lw003V3ActivityPayloadBxpIbeaconContentBinding;
...
public class PayloadBXPIBeaconContentActivity extends BaseActivity {
    ...
    private Lw003V3ActivityPayloadBxpIbeaconContentBinding mBind;
    private boolean savedParamsError;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = Lw003V3ActivityPayloadBxpIbeaconContentBinding.inflate(getLayoutInflater());
