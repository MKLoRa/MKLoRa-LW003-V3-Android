...
import com.moko.lw003v3.databinding.Lw003V3ActivityFilterBxpIbeaconBinding;
...
public class FilterBXPIBeaconActivity extends BaseActivity {
    ...
    private Lw003V3ActivityFilterBxpIbeaconBinding mBind;
    private boolean savedParamsError;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = Lw003V3ActivityFilterBxpIbeaconBinding.inflate(getLayoutInflater());
