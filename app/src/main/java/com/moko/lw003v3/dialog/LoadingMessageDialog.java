...
import com.moko.lw003v3.databinding.Lw003V3DialogLoadingMessageBinding;
import com.moko.lw003v3.view.ProgressDrawable;

import androidx.annotation.StringRes;
import androidx.core.content.ContextCompat;

public class LoadingMessageDialog extends MokoBaseDialog<Lw003V3DialogLoadingMessageBinding> {
    ...
    @Override
    protected Lw003V3DialogLoadingMessageBinding getViewBind(LayoutInflater inflater, ViewGroup container) {
        return Lw003V3DialogLoadingMessageBinding.inflate(inflater, container, false);
    }
