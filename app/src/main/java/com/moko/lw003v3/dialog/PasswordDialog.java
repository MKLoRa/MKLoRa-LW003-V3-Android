...
import com.moko.lw003v3.databinding.Lw003V3DialogPasswordBinding;
import com.moko.lw003v3.utils.ToastUtils;

public class PasswordDialog extends BaseDialog<Lw003V3DialogPasswordBinding> {
    ...
    @Override
    protected Lw003V3DialogPasswordBinding getViewBind() {
        return Lw003V3DialogPasswordBinding.inflate(getLayoutInflater());
    }
