...
import com.moko.lw003v3.databinding.Lw003V3DialogScanFilterBinding;

public class ScanFilterDialog extends BaseDialog<Lw003V3DialogScanFilterBinding> {
    private int filterRssi;
    private String filterName;

    @Override
    protected Lw003V3DialogScanFilterBinding getViewBind() {
        return Lw003V3DialogScanFilterBinding.inflate(getLayoutInflater());
    }
