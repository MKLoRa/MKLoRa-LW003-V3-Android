...
import com.moko.lw003v3.databinding.Lw003V3DialogChangePasswordBinding;
import com.moko.lw003v3.utils.ToastUtils;


public class ChangePasswordDialog extends BaseDialog<Lw003V3DialogChangePasswordBinding> {
    ...
    @Override
    protected Lw003V3DialogChangePasswordBinding getViewBind() {
        return Lw003V3DialogChangePasswordBinding.inflate(getLayoutInflater());
    }
